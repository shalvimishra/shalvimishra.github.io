    ...
    app:{
      head: {
        ...
        meta: [
          ...
          { name: 'og:image', content: `https://shalvimishra.github.io/og_image.jpeg` },
          { name: 'og:url', content: `https://shalvimishra.github.io` },
          // { name: 'twitter:card', content: `` },
          { name: 'twitter:title', content: `Eason Chen` },
          // { name: 'twitter:description', content: `` },
          { name: 'twitter:image', content: `https://shalvimishra.github.io/og_image.jpeg` },
